...
public class GenerateNo {
	...
	public static String getToken(String userId) {
		UUID uuid = UUID.randomUUID();
		String token = uuid.toString().replace("-", "")+userId;
		return token;
	}
	...
	public static String numOrdId() {
		...
		String randomString = String.valueOf(Math.random()).substring(2).substring(0, 5);
		System.out.println(num + number + randomString);
	...
	private static String IP = PropertiesFileUtil.getInstance("conf").get("HX.merchantID");
