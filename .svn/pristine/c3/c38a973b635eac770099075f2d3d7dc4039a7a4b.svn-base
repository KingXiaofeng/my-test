...
public class DecimalUtils {
	 ...
	 * @return
	 */
	public static BigDecimal getYearRates(double dayRates){
		BigDecimal yearRates = new BigDecimal(dayRates).multiply(new BigDecimal(365)).setScale(4, BigDecimal.ROUND_HALF_UP).multiply(new BigDecimal(100));
		return yearRates;
	}
	
	public static void main(String[] args) {

		System.out.println(getYearRates(0.03));
	}
}
