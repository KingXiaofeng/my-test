...
import com.yhb.requesturl.FileUploadRequestUrl;
 ...
 */
@Controller
@RequestMapping(FileUploadRequestUrl.file)
public class FileTransferController extends BaseController {
	...
	// Test
	@RequestMapping(FileUploadRequestUrl.index)
	 ...
	 *        2017年5月9日 wangxf v1.0.0 修改原因
	 */
	@RequestMapping(FileUploadRequestUrl.uploadImage)
