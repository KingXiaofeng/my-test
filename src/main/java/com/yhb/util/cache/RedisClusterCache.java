 ...
 * @Description: redis集群 缓存 采用Jedis Cluster
 * @author:Krx
 * @date: 2017年4月27日 上午10:28:16
 */
@Component
public class RedisClusterCache {

	public final static String CAHCE_NAME = "cache";// 缓存名
	public final static int CAHCE_TIME = 60;// 默认缓存时间
	...
	public void clearCache() {
		deleteCacheWithPattern(RedisClusterCache.CAHCE_NAME + "|*");
	}
