...
public class RequestUtils {
	...
	public static String getQueryParam(HttpServletRequest request, String name) {
		...
		if (request.getMethod().equalsIgnoreCase(BaseConstants.POST)) {
		...
		try {
			s = URLDecoder.decode(s, BaseConstants.UTF8);
		} catch (UnsupportedEncodingException e) {
			log.error("encoding " + BaseConstants.UTF8 + " not support?", e);
		}
