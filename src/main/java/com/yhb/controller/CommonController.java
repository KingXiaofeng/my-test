...
import com.yhb.requesturl.CommonRequestUrl;
 ...
 * @Description: 用户公共获取资源方法
 * @author:Krx
 * @date: 2017年4月27日 下午3:05:11
 */
@Controller
@RequestMapping(CommonRequestUrl.con)
public class CommonController extends BaseController{
     ...
     */
    @RequestMapping(CommonRequestUrl.commonInfo)
     ...
     * @date: 2017年5月12日 下午1:17:57
     */
    @RequestMapping(CommonRequestUrl.conBase)
