...
import com.yhb.dao.DealOrderDao;
...
public class DealOrderServiceImpl implements DealOrderService {
	...
	/**
	 * @see DealOrderService#insertDealOrder(java.util.Map)
	...
	/** 
	* @see DealOrderService#selectOrderByOrderNumber(java.lang.String)
	* @Function: DealOrderServiceImpl.java
	...
	*/
	...
	/** 
	* @see DealOrderService#updateDealOrder(com.yhb.bean.entity.DealOrder)
	* @Function: DealOrderServiceImpl.java
